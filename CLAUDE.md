...
For the canonical context map, see [`docs/00_system/010_governance/LIBRARY_MAP.md`](docs/00_system/010_governance/LIBRARY_MAP.md). For identity and voice, see [`docs/40_content/creators/daniel-hunt.md`](docs/40_content/creators/daniel-hunt.md); for visual art direction, [`docs/40_content/visual.md`](docs/40_content/visual.md); and for implementation tokens, type, geometry, and components, [`docs/40_content/design.md`](docs/40_content/design.md). Update the relevant source before changing anything brand-shaped on the site.
...
**Design tokens** (in `site/css/site.css`, canonicalized in `docs/40_content/design.md`):

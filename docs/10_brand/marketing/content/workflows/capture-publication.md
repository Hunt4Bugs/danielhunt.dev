...
- [Brand ontology v1](../../../ONTOLOGY.md): Publication, Creator, Creator Channel, Publication
...
- [Publication records](../publications/README.md): the Observed Publication this workflow
  produces.
- [Identity](../../../identity/README.md): truthfulness and evidence boundaries — an Observed

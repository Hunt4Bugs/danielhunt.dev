...
- [Brand ontology v1](../../../ONTOLOGY.md): Publication, Publication Format, derivation, and Asset relationships.
- [Publication records](../publications/README.md): record contract.
- [Channels](../../../channels/README.md): Channel registry and compatible Formats.

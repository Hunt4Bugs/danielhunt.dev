...
- Brand meaning and voice — owned by [Daniel Hunt](../40_content/creators/daniel-hunt.md) (Creator,
  `Self`) — and visual direction — owned by [`visual.md`](../40_content/visual.md); Site work
  must follow those before any brand-shaped implementation decision.
- The reusable design-token and component contract — owned by
  [`assets/design.md`](../40_content/design.md); `site/css/site.css` is that contract's
...
- `Page` **implements** the tokens and components defined in
  [`assets/design.md`](../40_content/design.md).
...
- Brand-shaped Site work must first follow [Daniel Hunt](../40_content/creators/daniel-hunt.md) and
  [`visual.md`](../40_content/visual.md) — this domain does not originate brand decisions.
...
- **[Daniel Hunt](../40_content/creators/daniel-hunt.md)** and **[Content](../40_content/README.md)** —

...
For brand strategy, persona, and content principles, see [IDENTITY.md](IDENTITY.md). For implementation tokens, typography, geometry, components, and modes, see [DESIGN.md](DESIGN.md).
...
Exact weights, scales, and fallbacks live in [DESIGN.md](DESIGN.md).

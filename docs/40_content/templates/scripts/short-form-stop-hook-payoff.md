...
facets:
  - content
related:
  - ../../workflows/generate-short-form-script.md
sources:
...
# Short-form Stop–Hook–Payoff Script Template

Create a Script Asset from an approved Blueprint. Replace every bracketed field with evidence-backed, production-feasible material.
...
## Scroll Stopper + Verbal Hook

**First visual frame:** [specific real frame, action, or text treatment]

**Visual intent:** [why the frame immediately locates the Topic]

**Spoken/on-screen hook:** [one concise promise, question, or open loop]

**Open loop:** [what the viewer expects resolved]
...
**Fulfilled promise:** [direct answer, reveal, or conclusion]

**Closing visual and line:** [specific ending]

**Intended audience feeling:** [emotion or perspective]

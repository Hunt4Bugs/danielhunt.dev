...
Version 1.0. This file is the reusable implementation contract for the website, social graphics, video titles, charts, carousels, and future brand surfaces. [Daniel Hunt](creators/daniel-hunt.md) owns meaning and voice. [Visual direction](visual.md) owns photography and editorial art direction. This file owns tokens, typography, geometry, components, and modes.

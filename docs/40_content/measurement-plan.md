---
id: content.note.measurement-plan
kind: note
domain: content
class: "40"
collection: content
...
This plan owns observation windows, operating success criteria, and interpretation rules. It measures the technical-reputation direction set by [Themes](themes.md), not a promised follower-growth trajectory.
...
Start the review clock when regular LinkedIn publishing begins, not on the documentation-change date. The [operating plan](operating-plan.md) owns the Tuesday/Thursday commitment.
...
After month six, retain monthly operating reviews and quarterly strategic reviews. An explicit decision in [Themes](themes.md) is required to change direction.
...
- Do not let an overperforming subject automatically override Daniel Hunt's identity, Themes, or strategic priorities.

...
For brand strategy, persona, and content principles, see [Daniel Hunt](creators/daniel-hunt.md) and [Themes](themes.md). For implementation tokens, typography, geometry, components, and modes, see [design](design.md).
...
Exact weights, scales, and fallbacks live in [design](design.md).

...
Write to `docs/40_content/topics/<slug>.md` using `docs/10_brand/assets/templates/topics/topic-record.md`. Derive `<slug>` by lowercasing the Topic record's title and hyphenating.

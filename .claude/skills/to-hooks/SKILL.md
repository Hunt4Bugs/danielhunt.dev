...
This skill produces one selected opening pair, plus discarded options and rejection reasons recorded in this run's own Work Item, on a Blueprint that is ready for hook development, following `docs/100_brand/marketing/content/workflows/generate-hook-options.md`.
